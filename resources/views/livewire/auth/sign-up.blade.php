          ...
          <div class="container">
              <div class="row justify-content-center">
                  <div class="col-lg-5 text-center mx-auto">
                      <h1 class="text-white mb-2 mt-5">{{ __('Appointment Form') }}</h1>
              ...
              <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                  <div class="card z-index-0">
                      <div class="card-header text-center pt-4">
                          <h5>{{ __('Create Appointment and Account') }}</h5>
                      </div>
                            ...
                            @error('custom_validation') <div class="text-danger">{{ $message }}</div> @enderror
                              ...
                              <div class="mb-3">
                                <div class="@error('phone') border border-danger rounded-3 @enderror">
                                    <input wire:model="phone" type="text" class="form-control" placeholder="Contact Number"
                               ...
                               <div class="mb-3">
                                  <div class="@error('location') border border-danger rounded-3 @enderror">
                                    <textarea   wire:model="location" type="text" class="form-control" placeholder="Address"
                                        aria-label="address" aria-describedby="address-addon" rows="4" cols="50">
                                    </textarea>
                                  </div>
                                ...
                                <div class="mb-3">
                                    <div class="@error('date_of_appointment') border border-danger rounded-3 @enderror">
                                        ...
                                        <input wire:model="date_of_appointment" type="date" class="form-control" placeholder="Appointment Date"
                                            aria-label="date_of_appointment" aria-describedby="date_of_appointment-addon">
                                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="@error('date_of_appointment') border border-danger rounded-3 @enderror">
                                        ...
                                        <select  class="form-control" wire:model="time_type">
                                ...
                                <div class="mb-3">
                                    <div class="@error('date_of_appointment') border border-danger rounded-3 @enderror">
                                        ...
                                        <select  class="form-control" wire:model="case_category_id">
                              ...
                              <div class="text-center">
                                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Submit Appointment</button>
                              </div>
