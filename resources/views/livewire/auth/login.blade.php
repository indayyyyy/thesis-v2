                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3 class="font-weight-bolder text-info text-gradient">{{ __('Hello, Welcome! ') }}</h3>
                            <p class="mb-0">{{ __('Schedule an appointment?')}}<br></p>
                            <p class="mb-0">
                                <a class="text-info text-gradient font-weight-bold" href="{{ route('sign-up') }}">
                                    Click here!
                                </a>
                            </p>
                            <p class="mb-0">{{__('OR Sign in your account below:') }}</p>
                        </div>
                        <div class="card-body">
